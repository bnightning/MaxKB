...
class ApplicationSerializer(serializers.Serializer):
    ...
    class Create(serializers.Serializer):
        ...
        @valid_license(model=Application, count=50000,
                       message=_(
                           'The community version supports up to 50000 applications. If you need more applications, please contact us (https://fit2cloud.com/).'))
        @transaction.atomic
